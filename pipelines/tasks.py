...
class CopyToFile(BaseTask):
    ...
    def __init__(self, table, output_file, connection = 'SMBD.db'):
        self.table = table
...
class LoadFile(BaseTask):
    ...
    def __init__(self, table, input_file, connection='SMBD.db'):
        self.table = table
...
class RunSQL(BaseTask):
    ...
    def __init__(self, sql_query, title=None, connection='SMBD.db'):
        self.title = title
...
class CTAS(BaseTask):
    ...
    def __init__(self, table, sql_query, title=None, connection='SMBD.db'):
        self.table = table
        self.sql_query = sql_query
